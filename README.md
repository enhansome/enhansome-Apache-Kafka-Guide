...
1. [Apache Kafka Learning Resources](https://github.com/mikeroyal/Apache-Kafka-Guide#Apache-Kafka-learning-resources) ⭐ 71 | 🐛 0 | 📅 2021-10-10

2. [Apache Kafka Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Apache-Kafka-Guide#Apache-Kafka-tools-libraries-and-frameworks) ⭐ 71 | 🐛 0 | 📅 2021-10-10

3. [Machine Learning](https://github.com/mikeroyal/Apache-Kafka-Guide#machine-learning) ⭐ 71 | 🐛 0 | 📅 2021-10-10

4. [Algorithms](https://github.com/mikeroyal/Apache-Kafka-Guide#Algorithms) ⭐ 71 | 🐛 0 | 📅 2021-10-10

5. [Deep Learning Development](https://github.com/mikeroyal/Apache-Kafka-Guide#Deep-Learning-Development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

6. [Reinforcement Learning Development](https://github.com/mikeroyal/Apache-Kafka-Guide#Reinforcement-Learning-Development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

7. [Computer Vision Development](https://github.com/mikeroyal/Apache-Kafka-Guide#computer-vision-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

8. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Apache-Kafka-Guide#nlp-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

9. [Bioinformatics](https://github.com/mikeroyal/Apache-Kafka-Guide#bioinformatics) ⭐ 71 | 🐛 0 | 📅 2021-10-10

10. [Databases](https://github.com/mikeroyal/Apache-Kafka-Guide#databases) ⭐ 71 | 🐛 0 | 📅 2021-10-10

11. [CUDA Development](https://github.com/mikeroyal/Apache-Kafka-Guide#cuda-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

12. [MATLAB Development](https://github.com/mikeroyal/Apache-Kafka-Guide#matlab-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

13. [Java Development](https://github.com/mikeroyal/Apache-Kafka-Guide#java-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

14. [Python Development](https://github.com/mikeroyal/Apache-Kafka-Guide#python-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

15. [C# Development](https://github.com/mikeroyal/Apache-Kafka-Guide#c-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

16. [Go Development](https://github.com/mikeroyal/Apache-Kafka-Guide#go-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

17. [Scala Development](https://github.com/mikeroyal/Apache-Kafka-Guide#scala-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

18. [R Development](https://github.com/mikeroyal/Apache-Kafka-Guide#r-development) ⭐ 71 | 🐛 0 | 📅 2021-10-10

# Awesome Apache Kafka Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/Apache-Kafka-Guide#table-of-contents) ⭐ 71 | 🐛 0 | 📅 2021-10-10
...
[IBM Streams](https://github.com/IBMStreams/streamsx.messaging) ⭐ 30 | 🐛 4 | 🌐 Java | 📅 2023-10-24 is a stream processing framework with Kafka source and sink to consume and produce Kafka messages.

[KaBoom](https://github.com/blackberry/KaBoom) ⚠️ Archived is a high-performance HDFS data loader.
...
[uReplicator](https://github.com/uber/uReplicator) ⭐ 936 | 🐛 78 | 🌐 Java | 📅 2023-12-16 is a tool that provides the ability to replicate across Kafka clusters in other data centers.

[Mirus](https://github.com/salesforce/mirus) ⭐ 210 | 🐛 28 | 🌐 Java | 📅 2026-08-05 is a tool for distributed, high-volume replication between Apache Kafka clusters based on Kafka Connect.

[Kafka Manager](https://github.com/yahoo/kafka-manager) ⭐ 11,927 | 🐛 522 | 🌐 Scala | 📅 2023-08-02 is a tool for managing Apache Kafka.

[Kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 is a simplified command-line administration for Kafka brokers.

[Kafka Web Console](https://github.com/claudemamo/kafka-web-console) ⚠️ Archived is a tool that displays information about your Kafka cluster including which nodes are up and what topics they host data for.
...
[Capillary](https://github.com/keenlabs/capillary) ⭐ 58 | 🐛 6 | 🌐 JavaScript | 📅 2019-12-20 is a tool that displays the state and deltas of Kafka-based Apache Storm topologies.
...
[Cruise Control](https://github.com/linkedin/cruise-control) ⭐ 3,039 | 🐛 289 | 🌐 Java | 📅 2026-08-12 is a tool that fully automate the dynamic workload rebalance and self-healing of a Kafka cluster.

[Burrow](https://github.com/linkedin/Burrow) ⭐ 3,958 | 🐛 251 | 🌐 Go | 📅 2026-07-16 is a monitoring tool that provides consumer lag checking as a service without the need for specifying thresholds.
...
[Caffe](https://github.com/BVLC/caffe) ⭐ 34,572 | 🐛 1,534 | 🌐 C++ | 📅 2024-07-31 is a deep learning framework made with expression, speed, and modularity in mind. It is developed by Berkeley AI Research (BAIR)/The Berkeley Vision and Learning Center (BVLC) and community contributors.
...
[Flair](https://github.com/flairNLP/flair) ⭐ 14,382 | 🐛 32 | 🌐 Python | 📅 2025-10-27 is a simple framework for state-of-the-art Natural Language Processing (NLP) models to your text, such as named entity recognition (NER), part-of-speech tagging (PoS), special support for biomedical data, sense disambiguation and classification, with support for a rapidly growing number of languages.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,175 | 🐛 382 | 🌐 Go | 📅 2026-08-13 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,590 | 🐛 157 | 🌐 Java | 📅 2026-07-31 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,106 | 🐛 141 | 🌐 Python | 📅 2026-07-29 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,584 | 🐛 320 | 🌐 Python | 📅 2026-08-12 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,416 | 🐛 329 | 🌐 Python | 📅 2024-12-17 is a command line HTTP client that makes CLI interaction with web services as easy as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,070 | 🐛 5 | 🌐 Python | 📅 2026-08-10 is an easy to use, scriptable and scalable performance testing tool.

[spaCy](https://github.com/explosion/spaCy) ⭐ 33,815 | 🐛 231 | 🌐 Python | 📅 2026-08-07 is a library for advanced Natural Language Processing in Python and Cython.
...
[MSBuild](https://github.com/dotnet/msbuild) ⭐ 5,542 | 🐛 1,660 | 🌐 C# | 📅 2026-08-13 is the build platform for .NET and Visual Studio. MSBuild, provides an XML schema for a project file that controls how the build platform processes and builds software. Visual Studio uses MSBuild to perform team builds through Azure DevOps Server, but MSBuild can run without Visual Studio.
...
[CodeMaid](https://github.com/codecadwallader/codemaid) ⭐ 1,984 | 🐛 506 | 🌐 C# | 📅 2025-10-13 is an open source Visual Studio extension to cleanup and simplify our C#, C++, F#, VB, PHP, PowerShell, JSON, XAML, XML, ASP, HTML, CSS, LESS, SCSS, JavaScript and TypeScript coding.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 22 | 🌐 TypeSpec | 📅 2026-08-12 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,152 | 🐛 120 | 🌐 Markdown | 📅 2026-08-09 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.

[Markdig](https://github.com/lunet-io/markdig) ⭐ 5,300 | 🐛 115 | 🌐 C# | 📅 2026-06-18 is a fast, powerful, [CommonMark](https://commonmark.org/) compliant, extensible Markdown processor for .NET.
...
[Uber's Go Style Guide](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 17,659 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,451 | 🐛 892 | 🌐 Go | 📅 2026-08-13 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,358 | 🐛 2,622 | 🌐 Go | 📅 2026-08-13 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.

[OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,222 | 🐛 31 | 🌐 Go | 📅 2026-07-02 is Serverless Functions Made Simple. It makes it easy for developers to deploy event-driven functions and microservices to Kubernetes without repetitive, boiler-plate coding. Package your code or an existing binary in a Docker image to get a highly scalable endpoint with auto-scaling and metrics.

[micro](https://github.com/zyedidia/micro) ⭐ 29,328 | 🐛 1,031 | 🌐 Go | 📅 2026-08-13 is a terminal-based text editor that aims to be easy to use and intuitive, while also taking advantage of the capabilities of modern terminals. As its name indicates, micro aims to be somewhat of a successor to the nano editor by being easy to install and use. It strives to be enjoyable as a full-time editor for people who prefer to work in a terminal, or those who regularly edit files over SSH.

[Gravitational Teleport](https://github.com/gravitational/teleport) ⭐ 20,802 | 🐛 3,453 | 🌐 Go | 📅 2026-08-13 is a modern security gateway for remotely accessing into Clusters of Linux servers via SSH or SSH-over-HTTPS in a browser or Kubernetes clusters.
...
[Act](https://github.com/nektos/act) ⭐ 71,498 | 🐛 361 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.

[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,354 | 🐛 228 | 🌐 JavaScript | 📅 2026-08-01 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,428 | 🐛 83 | 🌐 Go | 📅 2026-08-11, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.

[Glide](https://github.com/Masterminds/glide) ⭐ 8,086 | 🐛 400 | 🌐 Go | 📅 2024-07-22 is a vendor Package Management for Golang.

[BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,749 | 🐛 69 | 🌐 Go | 📅 2026-08-13 is an embeddable, persistent and fast key-value (KV) database written in pure Go. It is the underlying database for [Dgraph](https://dgraph.io/), a fast, distributed graph database. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.

[Go kit](https://github.com/go-kit/kit) ⭐ 27,426 | 🐛 60 | 🌐 Go | 📅 2024-07-19 is a programming toolkit for building microservices (or elegant monoliths) in Go. We solve common problems in distributed systems and application architecture so you can focus on delivering business value.
...
[zap](https://github.com/uber-go/zap) ⭐ 24,653 | 🐛 188 | 🌐 Go | 📅 2026-08-05 is a blazing fast, structured, leveled logging in Go.

[HttpRouter](https://github.com/julienschmidt/httprouter) ⭐ 17,133 | 🐛 84 | 🌐 Go | 📅 2024-07-22 is a lightweight high performance HTTP request router (also called multiplexer or just mux for short) for Go.

[Gorilla WebSocket](https://github.com/gorilla/websocket) ⭐ 24,849 | 🐛 78 | 🌐 Go | 📅 2025-03-19 is a Go implementation of the WebSocket protocol.

[Delve](https://github.com/go-delve/delve) ⭐ 24,875 | 🐛 88 | 🌐 Go | 📅 2026-08-12 is a debugger for the Go programming language.

[GORM](https://github.com/go-gorm/gorm) ⭐ 39,912 | 🐛 520 | 🌐 Go | 📅 2026-06-25 is a fantastic ORM library for Golang, aims to be developer friendly.

[Go Patterns](https://github.com/tmrts/go-patterns) ⭐ 28,169 | 🐛 66 | 🌐 Go | 📅 2024-05-14 is a curated collection of idiomatic design & application patterns for Go language.
...
[Databricks Scala Style Guide](https://github.com/databricks/scala-style-guide) ⭐ 2,807 | 🐛 14 | 📅 2024-04-05
...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,617 | 🐛 490 | 🌐 Scala | 📅 2026-08-13 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.

[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,289 | 🐛 1,839 | 🌐 Scala | 📅 2026-08-13 is a research compiler that will become Scala 3.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,286 | 🐛 844 | 🌐 JavaScript | 📅 2026-08-09.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Apache-Kafka-Guide/pulls) ⭐ 71 | 🐛 0 | 📅 2021-10-10.
